...
#ifndef PB_COMMON_CORE_PROTO_EXAMPLE_PB_H_INCLUDED
#define PB_COMMON_CORE_PROTO_EXAMPLE_PB_H_INCLUDED
#include <pb.h>
...
#define COMMON_CORE_PROTO_EXAMPLE_PB_H_MAX_SIZE  SimpleMessage_size
